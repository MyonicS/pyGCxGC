...
With a nice name in mind, [create a new repository](https://github.com/new?template_name=template&template_owner=MyonicS) using this template. Give it a name, a description, and decide if you want it to be public or private.
